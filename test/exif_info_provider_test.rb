...
class FolderStructureTest < Minitest::Test
  def test_can_get_file_size
    exif_image = PhotoOrganiser::ExifInfoProvider.get_info('images/image.jpg')
  ...
  def test_not_exif_is_nil
    exif_image = PhotoOrganiser::ExifInfoProvider.get_info('images/not_exif.jpg')

    refute exif_image.model
  end

  def test_not_image_is_nil
    exif_image = PhotoOrganiser::ExifInfoProvider.get_info('images/not_image.txt')
